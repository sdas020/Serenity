...
public class Cab_Book_Page extends PageObject { 
...
//    	WebDriver driver = new FirefoxDriver(firefoxBinary, firefoxProfile);
    	...
    	PageObject obj1;
    	driver.findElement(By.xpath("//*[@id='username']")).sendKeys("555192");
    	//departureCity.sendKeys(departure_City);
    	//DestinationCity.sendKeys(Destination_place);
    	driver.findElement(By.xpath("//*[@id='PasswordInternal']")).sendKeys("Happy@2018");
    	////*[@id='Log_On1']
